...
{
	glm::vec4 cy_color_up = glm::vec4(0.2, 0.5, 0.3, 1.0);
	glm::vec4 cy_color_down = glm::vec4(0.1, 0.0, 0.1, 1.0);
...
void ArmSkeleton::updateArmTarget(GLuint shaderProgramID)
{
	...
	*/
	armTargetTransformation = glm::translate(glm::mat4(1),glm::vec3(armTargetPos.x+2,armTargetPos.y+1,armTargetPos.z));
